...
urlpatterns = [
    ...
    path('auth/register/activate/<str:uidb64>/<str:token>/', views.activate_account, name='activate_account'),
    ...
    path('profile/edit_profile/<str:email>', views.edit_profile, name="edit_profile"),
